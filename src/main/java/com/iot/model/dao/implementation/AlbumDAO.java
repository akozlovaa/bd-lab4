...
public class AlbumDAO implements GeneralDAO<Album> {
    ...
    private static final String CREATE = "INSERT  spotify.album " + "( artist_id, name) VALUES (?,?)";
    private static final String UPDATE = "UPDATE spotify.album" + " SET artist_id=?, name=?  WHERE id=?";
